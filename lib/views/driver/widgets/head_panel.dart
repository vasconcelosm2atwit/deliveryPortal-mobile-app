            ...
            child: Card(
              ...
              child: Padding(
                padding: const EdgeInsets.only(
                    bottom: 10.0, left: 30.0, right: 10.0, top: 20.0),
                child: ListTile(
                    leading: const Icon(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        CustomText(
                          text:
                              "Total Completed: ${vm.completedDeliveriesCount}",
                          size: 15,
                          color: Colors.white54,
                        ),
                        CustomText(
                          text:
                              "Remaining Completed: ${vm.deliveryListCount - vm.completedDeliveriesCount}",
                          size: 15,
                          color: Colors.white54,
                        ),
                      ],
